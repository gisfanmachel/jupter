...
from pie.train_center.pytorch.train_epoch_step import train_model_step, auto_termination, save_checkpoint, \
    test_model_step
from pie.train_center.pytorch.model_deal.yolo_train_def import metrics_yolo_train, yolo_post_processing, epoch_loss_train, \
...
if __name__ == '__main__':
    ...
    for epoch in range(0, init_parse.epochs):
        ...
        valid_metrics, test_epoch_loss, middel_img_result,valid_labels = test_model_step(net,valid_loader,init_parse.network_type ,
                                                                                                 cuda,
                                                                                                 middel_img_result,
                                                                                                 loss_col,post_prcessing,metrics_col,**kwards)
