...
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\semantic_seg\_torch_models\encoders\inceptionresnetv2.py
...
class InceptionResNetV2Encoder(InceptionResNetV2, EncoderMixin):
    ...
    def make_dilated(self, stage_list, dilation_list):
        raise ValueError("InceptionResnetV2 encoder does not support dilated mode due to pooling operation for downsampling!")
...
inceptionresnetv2_encoders = {"inceptionresnetv2": {'encoder':InceptionResNetV2Encoder, 
