...
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\semantic_seg\_torch_models\encoders\inceptionv4.py
...
class InceptionV4Encoder(InceptionV4, EncoderMixin):
    ...
    def get_stages(self):
        return [
         nn.Identity(),
         self.features[None[:self._stage_idxs[0]]],
         ...
         self.features[self._stage_idxs[3][:None]]]
...
inceptionv4_encoders = {"inceptionv4": {'encoder':InceptionV4Encoder, 
                 'pretrained_settings':pretrained_settings["inceptionv4"], 
                 'params':{'stage_idxs':(3, 5, 9, 15), 
