...
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\semantic_seg\_torch_models\encoders\efficientnet.py
...
class EfficientNetEncoder(EfficientNet, EncoderMixin):
    ...
    def get_stages(self):
        return [
         ...
         self._blocks[None[:self._stage_idxs[0]]],
         self._blocks[self._stage_idxs[0][:self._stage_idxs[1]]],
         self._blocks[self._stage_idxs[1][:self._stage_idxs[2]]],
         self._blocks[self._stage_idxs[2][:None]]]
...
def _get_pretrained_settings(encoder):
    pretrained_settings = {"imagenet": {'mean':[
                   0.485, 0.456, 0.406], 
                  'std':[
                   0.229, 0.224, 0.225], 
                  'url':url_map[encoder], 
...
efficient_net_encoders = {'efficientnet-b0':{'encoder':EfficientNetEncoder, 
  'pretrained_settings':_get_pretrained_settings("efficientnet-b0"), 
  'params':{'out_channels':(3, 32, 24, 40, 112, 320), 
   'stage_idxs':(3, 5, 9, 16), 
