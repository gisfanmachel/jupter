...
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\semantic_seg\fpn_torch.py
...
class FpnEstimation(SegTorchEstimation):

    def __init__(self, model_path, config, test_aug=False, **kwargs):
        (super(FpnEstimation, self).__init__)(model_path, config, test_aug, **kwargs)


class FpnTrainer(SegTorchTrainer):
