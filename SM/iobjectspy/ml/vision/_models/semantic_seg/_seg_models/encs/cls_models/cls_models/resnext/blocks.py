...
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\semantic_seg\_seg_models\encs\cls_models\cls_models\resnext\blocks.py
...
def GroupConv2D(filters, kernel_size, conv_params, conv_name, strides=(1, 1), cardinality=32):
    ...
    def layer(input_tensor):
        ...
        for c in range(cardinality):
            x = Lambda((lambda z: z[(None[:None], None[:None], None[:None], (c * grouped_channels)[:(c + 1) * grouped_channels])]))(input_tensor)
