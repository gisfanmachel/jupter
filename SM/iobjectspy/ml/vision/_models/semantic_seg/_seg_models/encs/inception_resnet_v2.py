...
# Embedded file name: D:\BuildAgent\work\test/iobjectspy/ml\vision\_models\semantic_seg\_seg_models\encs\inception_resnet_v2.py
...
def inception_resnet_block(x, scale, block_type, block_idx, activation='relu'):
    ...
    x = Lambda((lambda inputs, scale: inputs[0] + inputs[1] * scale), output_shape=(K.int_shape(x)[1[:None]]),
